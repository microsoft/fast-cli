...
class SwatchRGBImpl extends ColorRGBA64 implements Swatch {
    ...
    public toColorString: () => string = this.toStringHexRGB;
    public contrast: any = contrast.bind(null, this);
    public createCSS: () => string = this.toColorString;

    static fromObject(obj: { r: number; g: number; b: number }): SwatchRGBImpl {
        return new SwatchRGBImpl(obj.r, obj.g, obj.b);
    }
}
