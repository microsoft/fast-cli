...
<h2>Previous</h2>
<${c => c.componentPrefix}-${c => c.tagName} direction="previous"></${c => c.componentPrefix}-${c => c.tagName}>

<h2>Previous with slotted content</h2>
<${c => c.componentPrefix}-${c => c.tagName} direction="previous">
    <svg
        slot="previous"
        width="16"
        height="16"
...
<h2>Next</h2>
<${c => c.componentPrefix}-${c => c.tagName} direction="next"></${c => c.componentPrefix}-${c => c.tagName}>

<h2>Next with slotted content</h2>
<${c => c.componentPrefix}-${c => c.tagName} direction="next">
    <svg
        slot="next"
        width="16"
        height="16"
...
<${c => c.componentPrefix}-${c => c.tagName} aria-hidden="false"></${c => c.componentPrefix}-${c => c.tagName}>
