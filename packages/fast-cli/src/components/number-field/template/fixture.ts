...
<h2>Hide step</h2>
<${config.componentPrefix}-${config.tagName} hide-step>Label</${config.componentPrefix}-${config.tagName}>

<h2>With value</h2>
<${config.componentPrefix}-${config.tagName} value="10"></${config.componentPrefix}-${config.tagName}>

<h2>With min 10 and max 100</h2>
<${config.componentPrefix}-${config.tagName} value="5" min="10" max="100"></${config.componentPrefix}-${config.tagName}>

<h2>0.1 stepping</h2>
<${config.componentPrefix}-${config.tagName} value="0.2" step=".1"></${config.componentPrefix}-${config.tagName}>
...
<!-- Read only -->
<h2>Read only</h2>
<${config.componentPrefix}-${config.tagName} readonly value="10"></${config.componentPrefix}-${config.tagName}>
<${config.componentPrefix}-${config.tagName} readonly value="20">label</${config.componentPrefix}-${config.tagName}>
...
<${config.componentPrefix}-${config.tagName} appearance="filled" readonly value="Readonly">
    label
</${config.componentPrefix}-${config.tagName}>
