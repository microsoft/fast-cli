...
export default tsTemplate`import { AccordionItem as FoundationAccordionItem, accordionItemTemplate, FoundationElementTemplate } from "@microsoft/fast-foundation";
